...
diccionario = {"Nombre de la calle" : "25 de Mayo", "Altura" : 2010, "Localidad" : "CABA", "Codigo Postal" : 1420, "Partido" : "Buenos Aires", "Provincia" : "Buenos Aires"}

print(diccionario["Nombre de la calle"], diccionario["Altura"])